...
export function GalleryListPage(props: GalleryListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getGalleries({
        relations: ['user', 'color_palette.count', 'design.count', 'motif.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('color_palette', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'color_palette',
          header: 'Color Palette',
          accessorKey: 'color_palette',
          cell: ({ row: { original: record } }: any) => record?._count?.color_palette,
        }
      : null,
    hasAccess('design', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Design',
          accessorKey: 'design',
          cell: ({ row: { original: record } }: any) => record?._count?.design,
        }
      : null,
    hasAccess('motif', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'motif',
          header: 'Motif',
          accessorKey: 'motif',
          cell: ({ row: { original: record } }: any) => record?._count?.motif,
        }
      : null,
