...
import { ColorPaletteListPage } from 'pages/color-palettes';
import { DesignListPage } from 'pages/designs';
import { MotifListPage } from 'pages/motifs';
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              ...
              <EntityImage entity="gallery" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
