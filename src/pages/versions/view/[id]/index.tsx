...
import { getVersionById } from 'apiSdk/versions';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('version', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/versions/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Version Number" text={data?.version_number} />
                ...
                {hasAccess('design', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Design"
                    text={
                      <Link as={NextLink} href={`/designs/view/${data?.design?.id}`}>
                        {data?.design?.name}
                      </Link>
                    }
                  />
