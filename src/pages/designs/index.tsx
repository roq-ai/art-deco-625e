...
export function DesignListPage(props: DesignListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getDesigns({
        relations: ['user', 'gallery', 'version.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('gallery', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('version', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'version',
          header: 'Version',
          accessorKey: 'version',
          cell: ({ row: { original: record } }: any) => record?._count?.version,
        }
      : null,
