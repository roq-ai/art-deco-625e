  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Art Deco, your personalized wall design tool. Infuse your spaces with vintage charm using our range of geometric motifs and customizable color palettes, inspired by the 1920s and 1930s."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1612487528505-d2338264c821?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBcnQlMjBEZWNvfGVufDB8fHx8MTY5NDM4Mjc3MXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Art Deco, your personalized wall design tool. Infuse your spaces with vintage charm using our range of geometric motifs and customizable color palettes, inspired by the 1920s and 1930s.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Gallery Owner" type="gallery-owner" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
